...
const ConfirmDialog = ({
  ...
  return (
    show && (
      <div
        className="absolute top-0 left-0 z-100 w-screen h-screen bg-blue-100/20  
            flex justify-center items-center"
        onClick={onCancel}
      >
        <div
          onClick={(e) => e.stopPropagation()}
          className="relative md:w-1/4 md:mb-48 bg-white shadow-2xl rounded-md
                p-4 text-gray-800  -translate-y-1/4"
        >
          <div className="font-bold px-1.5  text-gray-900 border-b border-b-gray-200 pb-1">
